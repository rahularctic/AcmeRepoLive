<?php namespace App\Http\Controllers\Website\PayTabs;

use  App\Http\Controllers\Website\PayTabs\Curl;
...
class PayTabs extends Controller
{
    ...
    */
    public function __construct()
    {
        ...
        $this->merchant_email= \Config::get('paytabs.merchant_email');
        $this->secret_key=\Config::get('paytabs.secret_key');
        $this->site_url=\Config::get('paytabs.site_url');
        $this->return_url = "http://phplaravel-16615-36254-102218.cloudwaysapps.com/paytabs/payment";
         //\Config::get('paytabs.return_url');
        $this->ip_merchant=\Config::get('paytabs.ip_merchant');
        $this->cms_with_version=\Config::get('paytabs.cms_with_version');
    ...
    */
    ...
    public function validatePaytabs()
    {
        //die("hello");
