        ...
        <div class="container clearfix">
            ...
            <div id="portfolio" class="clearfix">
                ...
                @foreach($allEvents as $event)
                    ...
                    <article  class="portfolio-item {{$event->EVENTTYPEID}}" class="{{$event->EVENTTYPEID}}" class="item-filter">
                        <span class="number" style="visibility: hidden;"> {{$event->StartTimeStamp}} </span>
                        <div class="portfolio-image">

                            <a href="portfolio-single.html">
                                <img src="{{asset('/img/event/'.$event->EVENTID.'/'.$event->EVENTIMAGE)}}" alt="{{$event->EVENTNAME}}">
                            </a>
                            <div class="portfolio-overlay">
                                <a href="{{URL('/event/'.$event->EVENTID.'/'. str_replace(' ', '-', $event->EVENTNAME) )}}" class="center-icon"><i class="icon-line-ellipsis"></i></a>
                            </div>
                        </div>
                        <div class="portfolio-desc">
                            <span> <span class="date"> {{$event->STARTDATE}} </span>
                            ...
                            <span> <small><i class="icon-map-marker2"></i> {{$event->EVENTLOCATION}} <a href="#">Icons</a></small></span>
                        </div>
                    </article>
