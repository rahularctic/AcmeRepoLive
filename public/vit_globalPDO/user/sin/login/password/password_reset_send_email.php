...
if(isset($_POST['token']) && isset($_POST['email']) ){ 
	...
	$url = BASEURL."/user/sin/login/password/password_reset_verify.php?email=".$email."&token=".$token;
...
<td class="content" style="font-size: normal; line-height: normal; font-style: normal; font-weight: normal; font-variant: normal; vertical-align: baseline; text-align: center !important; background: #ffffff; margin: 0; padding: 20px; border: 0;" align="center !important" bgcolor="#ffffff" valign="baseline">
                <h1 style="font-size: 2em; line-height: normal; font-style: normal; font-weight: 300; font-variant: normal; vertical-align: baseline; margin: 0 0 20px; padding: 0; border: 0;">Forgot your password?</h1>
                <p style="font-size: normal; line-height: 20pt; font-style: normal; font-weight: normal; font-variant: normal; vertical-align: baseline; color: #808080; margin: 0 0; padding: 0; border: 0;">Someone has asked to reset your password</p>
                <p style="font-size: normal; line-height: 20pt; font-style: normal; font-weight: normal; font-variant: normal; vertical-align: baseline; color: #808080; margin: 0 0 20px; padding: 0; border: 0;">If this was not you, please ignore this email</p>
                <h3 style="font-size: normal; border: 0; font-style: normal; font-variant: normal; padding: 0; line-height: normal; margin: 0; font-weight: normal; vertical-align: baseline;"><a href="'.$url.'" style="font-size: normal; border: 0; font-style: normal; font-variant: normal; padding: 0; line-height: normal; margin: 0; font-weight: normal; vertical-align: baseline; color: #f47932; text-decoration: none;">RESET MY PASSWORD</a></h3>
...
//  		$response["message"] = 'Mailer error: ' . $mail->ErrorInfo;
	...
	$response["success"] = 0;
	//$response["message"] = "No value for email or token";
	echo json_encode($response);
